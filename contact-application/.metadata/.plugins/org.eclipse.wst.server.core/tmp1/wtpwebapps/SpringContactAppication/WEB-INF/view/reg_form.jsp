	...
	<table border = "1"  width = "80%" align = "center">
		...
		<tr>
			<td height = "350px" valign = "top">
				...
				<s:url var = "registration_url" value="/register"></s:url>
				<f:form action = "${registration_url}" modelAttribute = "command">
					<table border = "1">
						...
						<tr>
							<td>User Name</td>
							<td><f:input id = "user_name" path = "user.loginName"/>
								<button type = "button" id ="check_availability">Check Availability</button>
								<div id = "availability_msg" class = "error" ></div>
							</td>
						</tr>
						<tr>
							<td>password</td>
